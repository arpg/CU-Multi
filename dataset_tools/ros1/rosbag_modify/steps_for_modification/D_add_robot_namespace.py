...
def main():
    env = "main_campus"
    root_input_dir = f'/root/datasets2/{env}'
    root_output_dir = f'/root/datasets2/{env}'
    robot_prefixes = ['robot4']
    
    for robot_prefix in robot_prefixes:
        robot_input_bag_path = f'{root_input_dir}/{robot_prefix}_{env}_shifted_raw.bag'
        robot_output_bag_path = f'{root_output_dir}/{robot_prefix}_{env}_shifted.bag'
